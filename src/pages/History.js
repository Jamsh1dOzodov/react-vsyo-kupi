                    ...
                    <div className='wrapper'>
                        ...
                        <div className='history'>
                            ...
                            <div className='history-accordion'>
                                <div onClick={accordion} className='history-accordion__top top'>
                                    <h4 className='top__title'>Заказ № 16894</h4>
                                    <div className='top-rightCol'>
                                        <button className='top-rightCol__btn'>Оплатить</button>
                                        <span className='top-rightCol__status'>Не оплачен</span>
                                        <div className={open ? 'top-rightCol__arrow' : 'top-rightCol__arrow top-rightCol__arrow--down'}><img src={arrow} /></div>
                                    </div>
                                </div>
                                <div className={open ? 'history-accordion__middle middle' : 'history-accordion__middle history-accordion__middle--close middle'}>
                            ...
                            <div className='history-accordion'>
                                <div onClick={accordion} className='history-accordion__top history-accordion__top--paid top'>
                                    <h4 className='top__title'>Заказ № 16894</h4>
                                    <div className='top-rightCol'>
                                        <button className='top-rightCol__btn'>Оплатить</button>
                                        <span className='top-rightCol__status'>Доставлен</span>
                                        <div className={open ? 'top-rightCol__arrow' : 'top-rightCol__arrow top-rightCol__arrow--down'}><img src={arrow} /></div>
                                    </div>
                                </div>
                                <div className={open ? 'history-accordion__middle middle' : 'history-accordion__middle history-accordion__middle--close middle'}>
